...
cat <<-EOH
# this file is generated via https://github.com/nginx-modules/docker-nginx-boringssl/blob/$(fileCommit "$self")/$self

Maintainers: Denis Denisov <denji0k@gmail.com> (@denji)
GitRepo: https://github.com/nginx-modules/docker-nginx-boringssl.git
EOH
